...
<div class="mx-auto flex w-full max-w-md flex-col items-center space-y-8 px-6 text-center">
	<!-- Logo/Brand area -->
	<div class="space-y-4">
		<img
			alt="Salora Logo"
	...
	<div class="space-y-2 text-center">
		...
		<p class="text-xs text-gray-400">Salora - Simpel afspraken beheer voor jouw bedrijf ❤️</p>
	</div>
</div>
