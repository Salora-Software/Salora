...
import { SchedulerInput, SchedulerModule, ProcessingContext } from "./core/types";
...
export class AvailabilityEngine<TConfig extends object = {}> {
	...
	public use<MConfig>(module: SchedulerModule<MConfig>): AvailabilityEngine<TConfig & MConfig> {
		return new AvailabilityEngine<TConfig & MConfig>([...this.modules, module]);
	}

	public useDefaultPipeline() {
		return this
			.use(new BufferModule())
